<template>
  <com-dialog
    ...
    :title="detail && detail.id ? '编辑壁纸' : '新建壁纸'"
    :width="'700px'"
      ...
      <div class="album-form-inline">
        <div class="inline-left">
          <el-form-item label="壁纸名称" prop="name">
            <el-input v-model="form.name" placeholder="请输入壁纸名称" size="large" />
          </el-form-item>
          <el-form-item label="壁纸简介" prop="desc">
            <el-input v-model="form.desc" placeholder="介绍一下该壁纸..." type="textarea" :rows="4" size="large" />
          </el-form-item>
        ...
        <div class="inline-right">
          <el-form-item label="壁纸封面" prop="cover">
...
const rules: FormRules = reactive({
  ...
  // ],
  // cover: [
  //   { required: true, message: '请上传壁纸封面图', trigger: ['blur', 'change'] }
  // ],
  name: [
